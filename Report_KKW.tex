...
\input{3-replication-package/output/tables/table2.tex}
...
\input{3-replication-package/output/tables/table3.tex}
...
\input{3-replication-package/output/tables/table4.tex}
...
\begin{table}[ht!]\scriptsize\centering
%\include{RAW_3-replication-package/output/tables/tableA1.tex}%
\include{3-replication-package/output/tables/tableA1.tex}
...
%\include{RAW_3-replication-package/output/tables/tableA4.tex}
...
\include{3-replication-package/output/tables/tableA4.tex}
...
\begin{table}[ht!]\scriptsize\centering
\input{3-replication-package/output/tables/tableA6.tex}
...
\begin{table}[ht!]\scriptsize\centering
\input{3-replication-package/output/tables/tableA7.tex}
...
\begin{table}[ht!]\scriptsize\centering
\input{3-replication-package/output/tables/tableA8.tex}
...
\begin{table}[ht!]\scriptsize\centering
%\include{RAW_3-replication-package/output/tables/tableB1.tex}
\include{3-replication-package/output/tables/tableB1.tex}
...
\begin{sidewaystable}[ht!]\scriptsize\centering
\input{3-replication-package/output/tables/tableC1.tex}
...
\input{3-replication-package/output/tables/figureA2_stats.tex}

\input{3-replication-package/output/tables/figure2_stats.tex}

\input{3-replication-package/output/tables/figure3_stats.tex}
