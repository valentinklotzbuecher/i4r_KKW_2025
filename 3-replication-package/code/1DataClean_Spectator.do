...
*===========================
	...
	*-> Quiz
		drop startdate enddate progress
		drop finished recordeddate responseid recipient* external*
		drop q_recaptchascore passQuiz
...
////////////////////////////////////////////////////////////VK
		destring scoreemployment, gen(tickNum_employ)
////////////////////////////////////////////////////////////VK
...
// alternative cutoffs
		...
		gen highEdu = (edu1 > 2)
		gen highIncome = (income1 > 70000)
		gen conservative = (party == "Republican")
	
////////////////////////////////////////////////////////////VK
// tab party conservative, m

replace female1 = . if male == "" | male == "Other or prefer not to say"

tab edu1 highEdu, m
replace highEdu = .   if edu == ""		//447 missings (most dropped later)

tab income1 highIncome, m
replace highIncome = .   if income1 ==  . // 481

replace conservative = . if party == ""		//447
...
////////////////////////////////////////////////////////////VK
// alternative cut (from 129 up)
		gen tooFast = (durationinseconds < 200)
		tab tooFast
...
tab edu1 highEdu, m
replace highEdu = .   if edu == ""		//339 missings (most dropped later)

tab income1 highIncome, m
replace highIncome = .   if income1 ==  . // 359

replace conservative = . if party == ""		//339
...
////////////////////////////////////////////////////////////VK
	...
	*--- Drop inattention
		...
		*-> Drop too fast
////////////////////////////////////////////////////////////VK
// alternative cut (from 180 up)
		destring durationinseconds, replace
		sum durationinseconds, detail	
		gen tooFast = (durationinseconds < 300)
		tab tooFast
